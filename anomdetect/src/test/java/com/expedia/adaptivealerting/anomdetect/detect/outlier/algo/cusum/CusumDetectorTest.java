...
public class CusumDetectorTest {
    ...
    private static List<CusumDetectorTestRow> data;
    ...
    public void testClassify_leftTailed() {
        ...
        val testRows = new CusumDetectorTestRow[]{
                new CusumDetectorTestRow(1020.0, AnomalyLevel.NORMAL.name()),
                new CusumDetectorTestRow(994.0, AnomalyLevel.WEAK.name()),
    ...
    public void testClassify_twoTailed() {
        ...
        val testRows = new CusumDetectorTestRow[]{
                new CusumDetectorTestRow(1000.0, AnomalyLevel.NORMAL.name()),
                new CusumDetectorTestRow(1020.0, AnomalyLevel.STRONG.name()),
                new CusumDetectorTestRow(994.0, AnomalyLevel.NORMAL.name()),
    ...
    private static void readDataFromCsv() {
        ...
        data = new CsvToBeanBuilder<CusumDetectorTestRow>(new InputStreamReader(is))
                .withType(CusumDetectorTestRow.class)
                .build()
                .parse();
    }
