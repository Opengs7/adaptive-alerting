...
public class OutlierThresholdsTest {
    private static final double TOLERANCE = 0.001;

    @Test
    public void testConstructor_happyPath() {
        val thresholds = new OutlierThresholds(100.0, 90.0, 20.0, 10.0);
